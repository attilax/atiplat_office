...
import com.jacob.com.Variant;
  ...
  public class WordToHtml {
       ...
       * @return
       */
      public static  String wordToTxt(String docfile ) 
      {WordToHtml w=new WordToHtml();
    	  
    	  String htmlfile = "c:\\"+god.getUUid()+".htm";
		w.wordToHtml(docfile,htmlfile);
      ...
      public static void main(String[] args) {
          ...
          wordtohtml.wordToHtml("C:\\ccx\\spdb ca.doc", "c://test.html");

...
public class Office2Tif {
 ...
 //	
	...
	//	new Office2Tif().ppt2tif("c:/00/研发项目管理办法.ppt","c:/officePdfOutput4ppt2tif");
	System.out.println("--f");
		 ...
		 */
	private void ppt2tif(String pptfile, String outDir) {
	 	Office2Html.	 	  convert(new File(pptfile), outDir);
		 ...
		 */
	void excel2tif(String excelFile, String outDir) {
		String pdfPath= excel2pdf(excelFile,outDir);
		 
			try {
				pdf2Imgs(pdfPath, outDir,"jpg");
			} catch (Exception e) {
		...
		/**
			 ...
			 */
		private String  excel2pdf(String excelFile, String outDir) {
			String pdfPath =outDir+"/"+ FilenameUtils.getBaseName(excelFile)+".pdf";
			try {
				doc2Pdf(excelFile, pdfPath);
				return pdfPath;
    ...
    public static List<String> pdf2Imgs(String pdfPath, String imgDirPath,  String exname) throws Exception {
		 ...
		 */
	public static void geneTif(String filePath) {
